...
public class Booster extends Tank {
    public Booster(float centerX, float centerY, float angle, Texture bodyTexture, Texture barrelTexture) {
        ...
        Barrel barrel3 = new Barrel(radius * 0.78f, radius / 2, 0, 149.5f, 0.1f, 0.6f, defaultRecoil * 0.25f, barrelTexture);
        Barrel barrel4 = new Barrel(radius * 0.72f, radius / 2, 0, 224.5f, 0.3f, 0.6f, defaultRecoil * 0.25f, barrelTexture);
        Barrel barrel5 = new Barrel(radius * 0.78f, radius / 2, 0, 209.5f, 0.1f, 0.6f, defaultRecoil * 0.25f, barrelTexture);
