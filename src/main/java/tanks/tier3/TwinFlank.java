...
public class TwinFlank extends Tank{
    public TwinFlank(float centerX, float centerY, float angle, Texture bodyTexture, Texture barrelTexture) {
        ...
        Barrel barrel3 = new Barrel(radius, radius/2, 12, 180, 0, 0.6f, defaultRecoil * 0.25f, barrelTexture);
        Barrel barrel4 = new Barrel(radius, radius / 2, -12, 180, 0.3f, 0.6f, defaultRecoil * 0.25f, barrelTexture);
